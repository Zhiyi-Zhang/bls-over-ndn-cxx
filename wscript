...
def build(bld):
    ...
    if bld.env.HAVE_OSX_FRAMEWORKS:
        ...
        bld(features='cxx',
            ...
            use='BOOST PTHREAD OSX_COREFOUNDATION OSX_SECURITY OSX_SYSTEMCONFIGURATION OSX_FOUNDATION OSX_COREWLAN gmp gmpxx mcl mclbn256 mclbn384 mclbn384_256 mclbn512 mclshe256 mclshe384 mclshe384_256 bls bls256 bls384 bls384_256',
            includes='.')
    ...
    libndn_cxx = dict(
        ...
        use='ndn-cxx-mm-objects version BOOST OPENSSL SQLITE3 ATOMIC RT PTHREAD gmp gmpxx mcl mclbn256 mclbn384 mclbn384_256 mclbn512 mclshe256 mclshe384 mclshe384_256 bls bls256 bls384 bls384_256',
        includes='.',
        export_includes='.',
        install_path='${LIBDIR}')
